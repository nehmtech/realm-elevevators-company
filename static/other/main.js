    ...
    sr.reveal('.contact-container .cols-2 h3, .def h2, .whyus h2', {delay:50, origin: 'top'})
    ...
    sr.reveal('.about-container-5 .column-1 ul li, .about-container-2 .column-2 .text', {delay:100, origin: 'bottom'})
